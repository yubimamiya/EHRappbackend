...
// YUBI: add endpoint URL to frontend app
param allowedOrigins array = ['https://icy-island-0d9782c0f.1.azurestaticapps.net']
...
// YUBI: set targetPort to 50505 so it is consistent with the container app
